...
// and a type-safe preference system. While originally designed for Discord bots, it can be used
// in any application requiring user-specific preference storage.
package userprefs
